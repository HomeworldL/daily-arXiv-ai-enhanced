...
### [1] [Spectral Kernel Dynamics via Maximum Caliber: Fixed Points, Geodesics, and Phase Transitions](https://arxiv.org/abs/2604.09745)
*Jnaneshwar Das*
...
### [2] [Kinematics of continuum planar grasping](https://arxiv.org/abs/2604.09800)
...
### [3] [Perception Is All You Need: A Neuroscience Framework for Low Cost Sensorless Gaze in HRI](https://arxiv.org/abs/2604.09829)
*Mason Kadem*
...
### [5] [CableTract: A Co-Designed Cable-Driven Field Robot for Low-Compaction, Off-Grid Capable Agriculture](https://arxiv.org/abs/2604.09938)
*Ozgur Yilmaz*
...
### [6] [GPU-Accelerated Continuous-Time Successive Convexification for Contact-Implicit Legged Locomotion](https://arxiv.org/abs/2604.09993)
...
### [7] [Vision-Language-Action Model, Robustness, Multi-modal Learning, Robot Manipulation](https://arxiv.org/abs/2604.10055)
...
### [8] [Natural Gradient Gaussian Approximation Filter on Lie Groups for Robot State Estimation](https://arxiv.org/abs/2604.10057)
...
### [9] [A Ray Intersection Algorithm for Fast Growth Distance Computation Between Convex Sets](https://arxiv.org/abs/2604.10058)
...
### [10] [MoRI: Mixture of RL and IL Experts for Long-Horizon Manipulation Tasks](https://arxiv.org/abs/2604.10165)
...
### [11] [Device-Conditioned Neural Architecture Search for Efficient Robotic Manipulation](https://arxiv.org/abs/2604.10170)
...
### [12] [ReaLiTy and LADS: A Unified Framework and Dataset Suite for LiDAR Adaptation Across Sensors and Adverse Weather Conditions](https://arxiv.org/abs/2604.10213)
...
### [13] [A Coordinate-Invariant Local Representation of Motion and Force Trajectories for Identification and Generalization Across Coordinate Systems](https://arxiv.org/abs/2604.10241)
...
### [14] [Trajectory-based actuator identification via differentiable simulation](https://arxiv.org/abs/2604.10351)
...
### [15] [AnySlot: Goal-Conditioned Vision-Language-Action Policies for Zero-Shot Slot-Level Placement](https://arxiv.org/abs/2604.10432)
...
### [16] [PRoID: Predicted Rate of Information Delivery in Multi-Robot Exploration and Relaying](https://arxiv.org/abs/2604.10433)
...
### [17] [VLN-NF: Feasibility-Aware Vision-and-Language Navigation with False-Premise Instructions](https://arxiv.org/abs/2604.10533)
...
### [18] [Simple but Stable, Fast and Safe: Achieve End-to-end Control by High-Fidelity Differentiable Simulation](https://arxiv.org/abs/2604.10548)
...
### [19] [AffordGen: Generating Diverse Demonstrations for Generalizable Object Manipulation with Afford Correspondence](https://arxiv.org/abs/2604.10579)
...
### [20] [MonoEM-GS: Monocular Expectation-Maximization Gaussian Splatting SLAM](https://arxiv.org/abs/2604.10593)
...
### [21] [AWARE: Adaptive Whole-body Active Rotating Control for Enhanced LiDAR-Inertial Odometry under Human-in-the-Loop Interaction](https://arxiv.org/abs/2604.10598)
...
### [22] [OmniUMI: Towards Physically Grounded Robot Learning via Human-Aligned Multimodal Interaction](https://arxiv.org/abs/2604.10647)
...
### [23] [LIDEA: Human-to-Robot Imitation Learning via Implicit Feature Distillation and Explicit Geometry Alignment](https://arxiv.org/abs/2604.10677)
...
### [24] [WARPED: Wrist-Aligned Rendering for Robot Policy Learning from Egocentric Human Demonstrations](https://arxiv.org/abs/2604.10809)
...
### [25] [BridgeSim: Unveiling the OL-CL Gap in End-to-End Autonomous Driving](https://arxiv.org/abs/2604.10856)
...
### [26] [HECTOR: Human-centric Hierarchical Coordination and Supervision of Robotic Fleets under Continual Temporal Tasks](https://arxiv.org/abs/2604.10892)
...
### [27] [Ro-SLM: Onboard Small Language Models for Robot Task Planning and Operation Code Generation](https://arxiv.org/abs/2604.10929)
...
### [28] [Fast-SegSim: Real-Time Open-Vocabulary Segmentation for Robotics in Simulation](https://arxiv.org/abs/2604.10951)
...
### [29] [Diffusion Reinforcement Learning Based Online 3D Bin Packing Spatial Strategy Optimization](https://arxiv.org/abs/2604.10953)
...
### [30] [ScoRe-Flow: Complete Distributional Control via Score-Based Reinforcement Learning for Flow Matching](https://arxiv.org/abs/2604.10962)
...
### [31] [Ψ-Map: Panoptic Surface Integrated Mapping Enables Real2Sim Transfer](https://arxiv.org/abs/2604.10982)
...
### [32] [Inferring World Belief States in Dynamic Real-World Environments](https://arxiv.org/abs/2604.11020)
...
### [33] [Federated Single-Agent Robotics: Multi-Robot Coordination Without Intra-Robot Multi-Agent Fragmentation](https://arxiv.org/abs/2604.11028)
...
### [34] [Simulator Adaptation for Sim-to-Real Learning of Legged Locomotion via Proprioceptive Distribution Matching](https://arxiv.org/abs/2604.11090)
...
### [35] [AIM: Intent-Aware Unified world action Modeling with Spatial Value Maps](https://arxiv.org/abs/2604.11135)
...
### [36] [ViserDex: Visual Sim-to-Real for Robust Dexterous In-hand Reorientation](https://arxiv.org/abs/2604.11138)
...
### [37] [EmbodiedGovBench: A Benchmark for Governance, Recovery, and Upgrade Safety in Embodied Agent Systems](https://arxiv.org/abs/2604.11174)
*Xue Qin,Simin Luan,John See,Cong Yang,Zhijun Li*
...
### [38] [CLAW: Composable Language-Annotated Whole-body Motion Generation](https://arxiv.org/abs/2604.11251)
...
### [39] [Modeling, Analysis and Activation of Planar Viscoelastically-combined Rimless Wheels](https://arxiv.org/abs/2604.11295)
...
### [40] [3D-Anchored Lookahead Planning for Persistent Robotic Scene Memory via World-Model-Based MCTS](https://arxiv.org/abs/2604.11302)
...
### [41] [Learning to Forget -- Hierarchical Episodic Memory for Lifelong Robot Deployment](https://arxiv.org/abs/2604.11306)
...
### [42] [CLASP: Closed-loop Asynchronous Spatial Perception for Open-vocabulary Desktop Object Grasping](https://arxiv.org/abs/2604.11320)
...
### [43] [Learning Racket-Ball Bounce Dynamics Across Diverse Rubbers for Robotic Table Tennis](https://arxiv.org/abs/2604.11349)
*Thomas Gossard*
...
### [44] [WM-DAgger: Enabling Efficient Data Aggregation for Imitation Learning with World Models](https://arxiv.org/abs/2604.11351)
...
### [45] [MR.ScaleMaster: Scale-Consistent Collaborative Mapping from Crowd-Sourced Monocular Videos](https://arxiv.org/abs/2604.11372)
...
### [46] [Minimal Embodiment Enables Efficient Learning of Number Concepts in Robot](https://arxiv.org/abs/2604.11373)
...
### [47] [ComSim: Building Scalable Real-World Robot Data Generation via Compositional Simulation](https://arxiv.org/abs/2604.11386)
...
### [48] [EagleVision: A Multi-Task Benchmark for Cross-Domain Perception in High-Speed Autonomous Racing](https://arxiv.org/abs/2604.11400)
...
### [49] [Using Unwrapped Full Color Space Palette Recording to Measure Exposedness of a Vehicle Exterior Parts for External Human Machine Interfaces](https://arxiv.org/abs/2604.11406)
...
### [50] [Efficient Emotion-Aware Iconic Gesture Prediction for Robot Co-Speech](https://arxiv.org/abs/2604.11417)
...
### [51] [Dyadic Partnership(DP): A Missing Link Towards Full Autonomy in Medical Robotics](https://arxiv.org/abs/2604.11423)
...
### [52] [Safe Human-to-Humanoid Motion Imitation Using Control Barrier Functions](https://arxiv.org/abs/2604.11447)
...
### [53] [DA-PTQ: Drift-Aware Post-Training Quantization for Efficient Vision-Language-Action Models](https://arxiv.org/abs/2604.11572)
...
### [54] [Micro-Dexterity in Biological Micromanipulation: Embodiment, Perception, and Control](https://arxiv.org/abs/2604.11640)
...
### [55] [AffordSim: A Scalable Data Generator and Benchmark for Affordance-Aware Robotic Manipulation](https://arxiv.org/abs/2604.11674)
...
### [56] [Dual-Control Frequency-Aware Diffusion Model for Depth-Dependent Optical Microrobot Microscopy Image Generation](https://arxiv.org/abs/2604.11680)
...
### [57] [ACT: Automated CPS Testing for Open-Source Robotic Platforms](https://arxiv.org/abs/2604.11708)
...
### [58] [Grounded World Model for Semantically Generalizable Planning](https://arxiv.org/abs/2604.11751)
...
### [59] [StarVLA-$α$: Reducing Complexity in Vision-Language-Action Systems](https://arxiv.org/abs/2604.11757)
...
### [60] [Identifying Inductive Biases for Robot Co-Design](https://arxiv.org/abs/2604.11768)
...
### [61] [Disentangled Point Diffusion for Precise Object Placement](https://arxiv.org/abs/2604.11793)
