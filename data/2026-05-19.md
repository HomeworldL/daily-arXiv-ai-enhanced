...
### [9] [Nori Bot: A Sub-$1,000 Floor-to-Counter Mobile Manipulator](https://arxiv.org/abs/2605.16537)
...
### [10] [Policy Library CBF: Finite-Horizon Safety at Runtime via Parallel Rollouts](https://arxiv.org/abs/2605.16588)
...
### [11] [Bayesian Networks for Path-Based Sensors: Gathering Information and Path Planning in Communication Denied Environments](https://arxiv.org/abs/2605.16673)
...
### [12] [DriveSafer: End-to-End Autonomous Driving with Safety Guidance](https://arxiv.org/abs/2605.16737)
...
### [13] [LACE: Latent Visual Representation for Cross-Embodiment Learning](https://arxiv.org/abs/2605.16743)
...
### [14] ["I'm Not Mad, Just Focused'': Understanding Human Emotions in Human-Robot Collaboration](https://arxiv.org/abs/2605.16816)
...
### [15] [Pedestrian-Aware LLM-Driven Behavioral Planning for Autonomous Vehicles](https://arxiv.org/abs/2605.16858)
...
### [16] [Plan First, Diffuse Later: Extrinsic Graph Guidance for Long-Horizon Diffusion Planning](https://arxiv.org/abs/2605.16863)
...
### [17] [SADP: Subgoal-Aware Diffusion Policy for Explainable Robots Learned from Foundation Model Generated Demonstrations](https://arxiv.org/abs/2605.16871)
...
### [18] [Beyond Safety Filtering: Control Barrier Function-Informed Reinforcement Learning for Connected and Automated Vehicles](https://arxiv.org/abs/2605.16894)
...
### [19] [MORN: Metacognitive Object-Goal Regulation for Resource-Rational Long-Horizon Navigation](https://arxiv.org/abs/2605.16932)
...
### [20] [NORM-Nav: Zero-Shot Mobile Robot Navigation with Natural Language Behavioral Constraints](https://arxiv.org/abs/2605.16979)
...
### [21] [Generalizable and Actionable Parts Pose Estimation with Symmetry Annotation-Free Learning Strategy](https://arxiv.org/abs/2605.17033)
...
### [22] [How to Instruct Your Robot: Dense Language Annotations Power Robot Policy Learning](https://arxiv.org/abs/2605.17077)
...
### [23] [Contrastive Conceptor Activation Steering (COAST): Unlocking Vision-Language-Action Models through Hidden States](https://arxiv.org/abs/2605.17144)
...
### [24] [Event-Grounded Sparse Autoencoders for Vision-Language-Action Policies](https://arxiv.org/abs/2605.17204)
...
### [25] [Generating Realistic Safety-Critical Scenarios for Vehicle-Pedestrian Interactions](https://arxiv.org/abs/2605.17229)
...
### [26] [SEDualVLN: A Spatially-Enhanced Dual-System for Vision-Language Navigation](https://arxiv.org/abs/2605.17249)
...
### [27] [Stretch-ICP: A Continuous-Trajectory Registration and Deskewing Algorithm in Scenarios of Aggressive Motions](https://arxiv.org/abs/2605.17264)
...
### [28] [Task Capability Improvement Algorithm for Collaborative Manipulators](https://arxiv.org/abs/2605.17293)
...
### [29] [HCLM: A Hierarchical Framework for Cooperative Loco-Manipulation with Dual Quadrupeds](https://arxiv.org/abs/2605.17300)
...
### [30] [Beyond Geometry: Efficient Topologically-Grounded Navigation in Complex 3D Environments](https://arxiv.org/abs/2605.17302)
...
### [31] [Efficient Feature-Free Initialization for Monocular Visual-Inertial Systems Using a Feed-Forward 3D Model](https://arxiv.org/abs/2605.17327)
...
### [32] [Tactile-based Multimodal Fusion in Embodied Intelligence: A Survey of Vision, Language, and Contact-Driven Paradigms](https://arxiv.org/abs/2605.17336)
...
### [33] [MUSE: Multimodal Uncertainty Quantification of State Estimation](https://arxiv.org/abs/2605.17421)
...
### [34] [Rapid Vibration Suppression and Trajectory Tracking of a Serial Manipulator with Multi-Flexible Links](https://arxiv.org/abs/2605.17477)
...
### [35] [DyGRO-VLA: Cross-Task Scaling of Vision-Language-Action Models via Dynamic Grouped Residual Optimization](https://arxiv.org/abs/2605.17486)
...
### [36] [AffordVLA: Injecting Affordance Representations into Vision-Language-Action Models via Implicit Feature Alignment](https://arxiv.org/abs/2605.17517)
...
### [37] [RoboFlow4D: A Lightweight Flow World Model Toward Real-Time Flow-Guided Robotic Manipulation](https://arxiv.org/abs/2605.17522)
...
### [38] [Visual Sculpting: Visually-Aligned Planning Representations for Long-Horizon Robot Clay Sculpting](https://arxiv.org/abs/2605.17556)
...
### [39] [Motion-Uncertainty-Aware Next-Best-View Planning for Moving Object Reconstruction](https://arxiv.org/abs/2605.17593)
...
### [40] [From a Single Demonstration to a General Policy for Contact-Rich Manipulation](https://arxiv.org/abs/2605.17601)
...
### [41] [Mono-Hydra++: Real-Time Monocular Scene Graph Construction with Multi-Task Learning for 3D Indoor Mapping](https://arxiv.org/abs/2605.17661)
...
### [42] [PRIME: Physically-consistent Robotic Inertial and Motion Estimation for Legged and Humanoid Robots](https://arxiv.org/abs/2605.17681)
...
### [43] [CosFly-Track: A Large-Scale Multi-Modal Dataset for UAV Visual Tracking via Multi-Constraint Trajectory Optimization](https://arxiv.org/abs/2605.17776)
...
### [44] [Optimal Knock-Pick Planning for Tightly Packed Tabletop Blocks With Parallel Grippers](https://arxiv.org/abs/2605.17800)
*Hao Lu,Rahul Shome*
...
### [45] [Virtues of Ordered Chaos: Planning with Topple Actions in Tabletop Stack Rearrangement](https://arxiv.org/abs/2605.17815)
*Hao Lu,Rahul Shome*
...
### [46] [A Dexterous and Compliant Gripper With Soft Hydraulic Actuation for Microgravity Manipulation](https://arxiv.org/abs/2605.17851)
...
### [47] [WorldArena 2.0: Extending Embodied World Model Benchmarking on Modality, Functionality and Platform](https://arxiv.org/abs/2605.17912)
...
### [48] [Learning-Based Adaptive Control for Surgical Robotic Exposure Task on Deformable Tissues](https://arxiv.org/abs/2605.17927)
...
### [49] [Transfer Learning for Customized Car Racing Environments](https://arxiv.org/abs/2605.17928)
...
### [50] [TacSE3: Equivariant SE(3) Motion Estimation from Low-Texture Visuotactile Images for In-Gripper Tracking and Compensation](https://arxiv.org/abs/2605.17929)
...
### [51] [Active Defense Against False Data Injection Attacks in Robotic Manipulators](https://arxiv.org/abs/2605.17950)
...
### [52] [Scenario Generation in Roundabouts with Adjustable Interaction Intensity](https://arxiv.org/abs/2605.18026)
...
### [53] [Confidence-Gated Robot Autonomy: When Does Uncertainty Actually Help?](https://arxiv.org/abs/2605.18045)
...
### [54] [FUSE: A Framework for Unified State Estimation in Robotic SLAM Systems](https://arxiv.org/abs/2605.18047)
...
### [55] [Bench2Drive-Robust: Benchmarking Closed-Loop Autonomous Driving under Deployment Perturbations](https://arxiv.org/abs/2605.18059)
...
### [56] [4DLidarOpen: An Open 4D FMCW Lidar Dataset for Motion-Aware Autonomous Driving](https://arxiv.org/abs/2605.18074)
...
### [57] [Fixed External Cameras as Common Prior Maps for Active 3D Scene Graph Generation](https://arxiv.org/abs/2605.18184)
...
### [58] [RGB-only Active 3D Scene Graph Generation for Indoor Mobile Robots](https://arxiv.org/abs/2605.18197)
*Giorgia Modi,Davide Buoso,Giuseppe Averta,Daniele De Martini*
...
### [59] [On Improving Multimodal Pedestrian Trajectory Prediction with CVAE: A Study on Benchmark and Robot Data](https://arxiv.org/abs/2605.18262)
...
### [60] [Assessing Localization Technologies for Pedestrian Collision Avoidance](https://arxiv.org/abs/2605.18295)
...
### [61] [Dynamic robotic cloth folding with efficient Koopman operator-based model predictive control](https://arxiv.org/abs/2605.18373)
...
### [62] [Towards Ubiquitous Mapping and Localization for Dynamic Indoor Environments](https://arxiv.org/abs/2605.18385)
...
### [63] [REBAR: Reference Ethical Benchmark for Autonomy Readiness](https://arxiv.org/abs/2605.18423)
...
### [64] [Bidirectional Optical sensors for Actuation Tracking (BOAT) in soft lattice systems](https://arxiv.org/abs/2605.18482)
...
### [65] [Geometry-Aware Surrogate for Real-Time Hydrodynamics Estimation of Autonomous Ground Vehicles in Amphibious Environments](https://arxiv.org/abs/2605.18543)
...
### [66] [Key-Gram: Extensible World Knowledge for Embodied Manipulation](https://arxiv.org/abs/2605.18556)
...
### [67] [Unified Walking, Running, and Recovery for Humanoids via State-Dependent Adversarial Motion Priors](https://arxiv.org/abs/2605.18611)
...
### [68] [ManiSoft: Towards Vision-Language Manipulation for Soft Continuum Robotics](https://arxiv.org/abs/2605.18617)
...
### [69] [Data-Driven Dynamic Modeling of a Tendon-Actuated Continuum Robot](https://arxiv.org/abs/2605.18720)
...
### [70] [Dexora: Open-source VLA for High-DoF Bimanual Dexterity](https://arxiv.org/abs/2605.18722)
...
### [71] [DexHoldem: Playing Texas Hold'em with Dexterous Embodied System](https://arxiv.org/abs/2605.18727)
...
### [72] [Robo-Cortex: A Self-Evolving Embodied Agent via Dual-Grain Cognitive Memory and Autonomous Knowledge Induction](https://arxiv.org/abs/2605.18729)
