...
### [29] [IMPACT: An Implicit Active-Set Augmented Lagrangian for Fast Contact-Implicit Trajectory Optimization](https://arxiv.org/abs/2605.09127)
...
### [30] [Beyond Self-Play: Hierarchical Reasoning for Continuous Motion in Closed-Loop Traffic Simulation](https://arxiv.org/abs/2605.09153)
...
### [31] [Continuum Robot Modeling with Action Conditioned Flow Matching](https://arxiv.org/abs/2605.09216)
...
### [32] [Mismatch-Aware Adaptive Constraint Tightening for Bicycle-Model Trajectory Optimization](https://arxiv.org/abs/2605.09376)
...
### [33] [Safety-Critical LiDAR-Inertial Odometry with On-Manifold Deterministic Protection Level](https://arxiv.org/abs/2605.09383)
...
### [34] [RePO-VLA: Recovery-Driven Policy Optimization for Vision-Language-Action Models](https://arxiv.org/abs/2605.09410)
...
### [35] [Beyond Isolation: A Unified Benchmark for General-Purpose Navigation](https://arxiv.org/abs/2605.09441)
...
### [36] [High Precision Hydraulic Excavator Control for Heavy-Duty Grading](https://arxiv.org/abs/2605.09465)
...
### [37] [LASSA Architecture-Based Autonomous Fault-Tolerant Control of Unmanned Underwater Vehicles](https://arxiv.org/abs/2605.09494)
...
### [38] [Drift is a Sampling Error: SNR-Aware Power Distributions for Long-Horizon Robotic Planning](https://arxiv.org/abs/2605.09537)
...
### [39] [SABER: A Scalable Action-Based Embodied Dataset for Real-World VLA Adaptation](https://arxiv.org/abs/2605.09613)
...
### [40] [Minimizing Worst-Case Weighted Latency for Multi-Robot Persistent Monitoring: Theory and RL-Based Solutions](https://arxiv.org/abs/2605.09633)
...
### [41] [ORICF -- Open Robotics Inference and Control Framework](https://arxiv.org/abs/2605.09656)
...
### [42] [ASACK : Adaptive Safe Active Continual Koopman Learning for Uncertain Systems with Contractive Guarantees](https://arxiv.org/abs/2605.09659)
...
### [43] [Towards Generative Predictive Display for Vision-Based Teleoperation: A Zero-Shot Benchmark of Off-the-Shelf Video Models](https://arxiv.org/abs/2605.09670)
...
### [44] [MVB-Grasp: Minimum-Volume-Box Filtering of Diffusion-based Grasps for Frontal Manipulation](https://arxiv.org/abs/2605.09672)
...
### [45] [Zero-Shot Sim-to-Real Robot Learning: A Dexterous Manipulation Study on Reactive Catching](https://arxiv.org/abs/2605.09789)
...
### [46] [Efficient Multi-Robot Motion Planning with Precomputed Translation-Invariant Edge Bundles](https://arxiv.org/abs/2605.09801)
...
### [47] [Above and Below: Heterogeneous Multi-robot SLAM Across Surface and Underwater Domains](https://arxiv.org/abs/2605.09811)
...
### [48] [ConsistNav: Closing the Action Consistency Gap in Zero-Shot Object Navigation with Semantic Executive Control](https://arxiv.org/abs/2605.09869)
...
### [49] [Network-Efficient World Model Token Streaming](https://arxiv.org/abs/2605.09886)
...
### [50] [Neural Distance-Guided Path Integral Control for Tractor-Trailer Navigation](https://arxiv.org/abs/2605.09939)
...
### [51] [Explicit Stair Geometry Conditioning for Robust Humanoid Locomotion](https://arxiv.org/abs/2605.09944)
...
### [52] [JODA: Composable Joint Dynamics for Articulated Objects](https://arxiv.org/abs/2605.09954)
...
### [53] [HiDrive: A Closed-Loop Benchmark for High-Level Autonomous Driving](https://arxiv.org/abs/2605.09972)
...
### [54] [StereoPolicy: Improving Robotic Manipulation Policies via Stereo Perception](https://arxiv.org/abs/2605.09989)
...
### [55] [Muninn: Your Trajectory Diffusion Model But Faster](https://arxiv.org/abs/2605.09999)
...
### [56] [Beyond Self-Play and Scale: A Behavior Benchmark for Generalization in Autonomous Driving](https://arxiv.org/abs/2605.10034)
...
### [57] [Guided Streaming Stochastic Interpolant Policy](https://arxiv.org/abs/2605.10051)
...
### [58] [EFGCL: Learning Dynamic Motion through Spotting-Inspired External Force Guided Curriculum Learning](https://arxiv.org/abs/2605.10063)
...
### [59] [A cell-decomposition based path planner for 3D navigation in constrained workspaces](https://arxiv.org/abs/2605.10086)
...
### [60] [Retrieve-then-Steer: Online Success Memory for Test-Time Adaptation of Generative VLAs](https://arxiv.org/abs/2605.10094)
...
### [61] [Plan in Sandbox, Navigate in Open Worlds: Learning Physics-Grounded Abstracted Experience for Embodied Navigation](https://arxiv.org/abs/2605.10118)
...
### [62] [Data-Asymmetric Latent Imagination and Reranking for 3D Robotic Imitation Learning](https://arxiv.org/abs/2605.10166)
...
### [63] [HeteroGenManip: Generalizable Manipulation For Heterogeneous Object Interactions](https://arxiv.org/abs/2605.10201)
...
### [64] [Nano-U: Efficient Terrain Segmentation for Tiny Robot Navigation](https://arxiv.org/abs/2605.10210)
...
### [65] [Learning Point Cloud Geometry as a Statistical Manifold: Theory and Practice](https://arxiv.org/abs/2605.10456)
...
### [66] [VEGA: Visual Encoder Grounding Alignment for Spatially-Aware Vision-Language-Action Models](https://arxiv.org/abs/2605.10485)
...
### [67] [Embodied AI in Action: Insights from SAE World Congress 2026 on Safety, Trust, Robotics, and Real-World Deployment](https://arxiv.org/abs/2605.10653)
...
### [68] [VRA: Grounding Discrete-Time Joint Acceleration in Voltage-Constrained Actuation](https://arxiv.org/abs/2605.10696)
...
### [69] [ObjView-Bench: Rethinking Difficulty and Deployment for Object-Centric View Planning](https://arxiv.org/abs/2605.10707)
...
### [70] [MAGS-SLAM: Monocular Multi-Agent Gaussian Splatting SLAM for Geometrically and Photometrically Consistent Reconstruction](https://arxiv.org/abs/2605.10760)
...
### [71] [ALAM: Algebraically Consistent Latent Transitions for Vision-Language-Action Models](https://arxiv.org/abs/2605.10819)
...
### [72] [Unified Noise Steering for Efficient Human-Guided VLA Adaptation](https://arxiv.org/abs/2605.10821)
...
### [73] [Safe Aerial 3D Path Planning for Autonomous UAVs using Magnetic Potential Fields](https://arxiv.org/abs/2605.10880)
...
### [74] [MDrive: Benchmarking Closed-Loop Cooperative Driving for End-to-End Multi-agent Systems](https://arxiv.org/abs/2605.10904)
...
### [75] [RoboMemArena: A Comprehensive and Challenging Robotic Memory Benchmark](https://arxiv.org/abs/2605.10921)
...
### [76] [PriorVLA: Prior-Preserving Adaptation for Vision-Language-Action Models](https://arxiv.org/abs/2605.10925)
...
### [77] [HarmoWAM: Harmonizing Generalizable and Precise Manipulation via Adaptive World Action Models](https://arxiv.org/abs/2605.10942)
