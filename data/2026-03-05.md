...
### [6] [Overlapping Domain Decomposition for Distributed Pose Graph Optimization](https://arxiv.org/abs/2603.03499)
...
### [7] [Sampling-Based Motion Planning with Scene Graphs Under Perception Constraints](https://arxiv.org/abs/2603.03514)
...
### [8] [Passive Phase-Oriented Impedance Shaping for Rapid Acceleration in Soft Robotic Swimmers](https://arxiv.org/abs/2603.03537)
...
### [9] [Real-time loosely coupled GNSS and IMU integration via Factor Graph Optimization](https://arxiv.org/abs/2603.03546)
...
### [10] [Real-time tightly coupled GNSS and IMU integration via Factor Graph Optimization](https://arxiv.org/abs/2603.03556)
...
### [11] [MEM: Multi-Scale Embodied Memory for Vision Language Action Models](https://arxiv.org/abs/2603.03596)
...
### [12] [Touch2Insert: Zero-Shot Peg Insertion by Touching Intersections of Peg and Hole](https://arxiv.org/abs/2603.03627)
...
### [13] [MistyPilot: An Agentic Fast-Slow Thinking LLM Framework for Misty Social Robots](https://arxiv.org/abs/2603.03640)
...
### [14] [TreeLoc++: Robust 6-DoF LiDAR Localization in Forests with a Compact Digital Forest Inventory](https://arxiv.org/abs/2603.03695)
...
### [15] [UrbanHuRo: A Two-Layer Human-Robot Collaboration Framework for the Joint Optimization of Heterogeneous Urban Services](https://arxiv.org/abs/2603.03701)
...
### [16] [Large-Language-Model-Guided State Estimation for Partially Observable Task and Motion Planning](https://arxiv.org/abs/2603.03704)
...
### [17] [X-Loco: Towards Generalist Humanoid Locomotion Control via Synergetic Policy Distillation](https://arxiv.org/abs/2603.03733)
...
### [18] [Characterization and Correlation of Robotic Snake Scale Friction and Locomotion Speed](https://arxiv.org/abs/2603.03735)
...
### [19] [Whole-Body Safe Control of Robotic Systems with Koopman Neural Dynamics](https://arxiv.org/abs/2603.03740)
...
### [20] [HALyPO: Heterogeneous-Agent Lyapunov Policy Optimization for Human-Robot Collaboration](https://arxiv.org/abs/2603.03741)
...
### [21] [Interaction-Aware Whole-Body Control for Compliant Object Transport](https://arxiv.org/abs/2603.03751)
...
### [22] [Cognition to Control - Multi-Agent Learning for Human-Humanoid Collaborative Transport](https://arxiv.org/abs/2603.03768)
...
### [23] [Learning Surgical Robotic Manipulation with 3D Spatial Priors](https://arxiv.org/abs/2603.03798)
...
### [24] [SkillVLA: Tackling Combinatorial Diversity in Dual-Arm Manipulation via Skill Reuse](https://arxiv.org/abs/2603.03836)
...
### [25] [IROSA: Interactive Robot Skill Adaptation using Natural Language](https://arxiv.org/abs/2603.03897)
...
### [26] [Lightweight Visual Reasoning for Socially-Aware Robots](https://arxiv.org/abs/2603.03942)
...
### [27] [RVN-Bench: A Benchmark for Reactive Visual Navigation](https://arxiv.org/abs/2603.03953)
...
### [28] [ArthroCut: Autonomous Policy Learning for Robotic Bone Resection in Knee Arthroplasty](https://arxiv.org/abs/2603.03957)
...
### [29] [Structural Action Transformer for 3D Dexterous Manipulation](https://arxiv.org/abs/2603.03960)
...
### [30] [Right in Time: Reactive Reasoning in Regulated Traffic Spaces](https://arxiv.org/abs/2603.03977)
...
### [31] [Map-Agnostic And Interactive Safety-Critical Scenario Generation via Multi-Objective Tree Search](https://arxiv.org/abs/2603.03978)
...
### [32] [Self-adapting Robotic Agents through Online Continual Reinforcement Learning with World Model Feedback](https://arxiv.org/abs/2603.04029)
...
### [33] [Force-Aware Residual DAgger via Trajectory Editing for Precision Insertion with Impedance Control](https://arxiv.org/abs/2603.04038)
...
### [34] [HE-VPR: Height Estimation Enabled Aerial Visual Place Recognition Against Scale Variance](https://arxiv.org/abs/2603.04050)
...
### [35] [Sim2Sea: Sim-to-Real Policy Transfer for Maritime Vessel Navigation in Congested Waters](https://arxiv.org/abs/2603.04057)
...
### [36] [SaFeR: Safety-Critical Scenario Generation for Autonomous Driving Test via Feasibility-Constrained Token Resampling](https://arxiv.org/abs/2603.04071)
...
### [37] [Swimming Under Constraints: A Safe Reinforcement Learning Framework for Quadrupedal Bio-Inspired Propulsion](https://arxiv.org/abs/2603.04073)
...
### [38] [Modeling and Control of a Pneumatic Soft Robotic Catheter Using Neural Koopman Operators](https://arxiv.org/abs/2603.04118)
...
### [39] [HBRB-BoW: A Retrained Bag-of-Words Vocabulary for ORB-SLAM via Hierarchical BRB-KMeans](https://arxiv.org/abs/2603.04144)
...
### [40] [GarmentPile++: Affordance-Driven Cluttered Garments Retrieval with Vision-Language Reasoning](https://arxiv.org/abs/2603.04158)
...
### [41] [Learning Hip Exoskeleton Control Policy via Predictive Neuromusculoskeletal Simulation](https://arxiv.org/abs/2603.04166)
...
### [42] [GSeg3D: A High-Precision Grid-Based Algorithm for Safety-Critical Ground Segmentation in LiDAR Point Clouds](https://arxiv.org/abs/2603.04208)
...
### [43] [PRAM-R: A Perception-Reasoning-Action-Memory Framework with LLM-Guided Modality Routing for Adaptive Autonomous Driving](https://arxiv.org/abs/2603.04222)
...
### [44] [AMP2026: A Multi-Platform Marine Robotics Dataset for Tracking and Mapping](https://arxiv.org/abs/2603.04225)
...
### [45] [RoboLight: A Dataset with Linearly Composable Illumination for Robotic Manipulation](https://arxiv.org/abs/2603.04249)
...
### [46] [VANGUARD: Vehicle-Anchored Ground Sample Distance Estimation for UAVs in GPS-Denied Environments](https://arxiv.org/abs/2603.04277)
...
### [47] [OmniPlanner: Universal Exploration and Inspection Path Planning across Robot Morphologies](https://arxiv.org/abs/2603.04284)
...
### [48] [Compliant In-hand Rolling Manipulation Using Tactile Sensing](https://arxiv.org/abs/2603.04301)
...
### [49] [Perception-Aware Time-Optimal Planning for Quadrotor Waypoint Flight](https://arxiv.org/abs/2603.04305)
...
### [50] [Gaussian Mixture-Based Inverse Perception Contract for Uncertainty-Aware Robot Navigation](https://arxiv.org/abs/2603.04329)
...
### [51] [Tendon Force Modeling for Sim2Real Transfer of Reinforcement Learning Policies for Tendon-Driven Robots](https://arxiv.org/abs/2603.04351)
...
### [52] [A Soft Robotic Demonstration in the Stratospher](https://arxiv.org/abs/2603.04352)
...
### [53] [RoboCasa365: A Large-Scale Simulation Framework for Training and Benchmarking Generalist Robots](https://arxiv.org/abs/2603.04356)
...
### [54] [ManipulationNet: An Infrastructure for Benchmarking Real-World Robot Manipulation with Physical Skill Challenges and Embodied Multimodal Reasoning](https://arxiv.org/abs/2603.04363)
