...
### [3] [Efficient and Reliable Teleoperation through Real-to-Sim-to-Real Shared Autonomy](https://arxiv.org/abs/2603.17016)
...
### [4] [Contingency-Aware Planning via Certified Neural Hamilton-Jacobi Reachability](https://arxiv.org/abs/2603.17022)
...
### [5] [TeleDex: Accessible Dexterous Teleoperation](https://arxiv.org/abs/2603.17065)
...
### [6] [SLowRL: Safe Low-Rank Adaptation Reinforcement Learning for Locomotion](https://arxiv.org/abs/2603.17092)
...
### [7] [Shielded Reinforcement Learning Under Dynamic Temporal Logic Constraints](https://arxiv.org/abs/2603.17152)
...
### [8] [SLAM Adversarial Lab: An Extensible Framework for Visual SLAM Robustness Evaluation under Adverse Conditions](https://arxiv.org/abs/2603.17165)
...
### [9] [Influence of Gripper Design on Human Demonstration Quality for Robot Learning](https://arxiv.org/abs/2603.17189)
...
### [10] [FastLoop: Parallel Loop Closing with GPU-Acceleration in Visual SLAM](https://arxiv.org/abs/2603.17201)
...
### [11] [Visual SLAM with DEM Anchoring for Lunar Surface Navigation](https://arxiv.org/abs/2603.17229)
...
### [12] [Full Stack Navigation, Mapping, and Planning for the Lunar Autonomy Challenge](https://arxiv.org/abs/2603.17232)
...
### [13] [Neural Radiance Maps for Extraterrestrial Navigation and Path Planning](https://arxiv.org/abs/2603.17236)
...
### [14] [ReSteer: Quantifying and Refining the Steerability of Multitask Robot Policies](https://arxiv.org/abs/2603.17300)
...
### [15] [DexEXO: A Wearability-First Dexterous Exoskeleton for Operator-Agnostic Demonstration and Learning](https://arxiv.org/abs/2603.17323)
...
### [16] [OmniVLN: Omnidirectional 3D Perception and Token-Efficient LLM Reasoning for Visual-Language Navigation across Air and Ground Platforms](https://arxiv.org/abs/2603.17351)
...
### [17] [Physics-informed Deep Mixture-of-Koopmans Vehicle Dynamics Model with Dual-branch Encoder for Distributed Electric-drive Trucks](https://arxiv.org/abs/2603.17416)
...
### [18] [SafeLand: Safe Autonomous Landing in Unknown Environments with Bayesian Semantic Mapping](https://arxiv.org/abs/2603.17430)
...
### [19] [FloorPlan-VLN: A New Paradigm for Floor Plan Guided Vision-Language Navigation](https://arxiv.org/abs/2603.17437)
...
### [20] [P$^{3}$Nav: End-to-End Perception, Prediction and Planning for Vision-and-Language Navigation](https://arxiv.org/abs/2603.17459)
...
### [21] [Bringing Network Coding into Multi-Robot Systems: Interplay Study for Autonomous Systems over Wireless Communications](https://arxiv.org/abs/2603.17472)
...
### [22] [From Optimizable to Interactable: Mixed Digital Twin-Empowered Testing of Vehicle-Infrastructure Cooperation Systems](https://arxiv.org/abs/2603.17497)
...
### [23] [Interpreting Context-Aware Human Preferences for Multi-Objective Robot Navigation](https://arxiv.org/abs/2603.17510)
...
### [24] [KineVLA: Towards Kinematics-Aware Vision-Language-Action Models with Bi-Level Action Decomposition](https://arxiv.org/abs/2603.17524)
...
### [25] [HeiSD: Hybrid Speculative Decoding for Embodied Vision-Language-Action Models with Kinematic Awareness](https://arxiv.org/abs/2603.17573)
...
### [26] [VectorWorld: Efficient Streaming World Model via Diffusion Flow on Vector Graphs](https://arxiv.org/abs/2603.17652)
...
### [27] [REAL: Robust Extreme Agility via Spatio-Temporal Policy Learning and Physics-Guided Filtering](https://arxiv.org/abs/2603.17653)
...
### [28] [Consistency-Driven Dual LSTM Models for Kinematic Control of a Wearable Soft Robotic Arm](https://arxiv.org/abs/2603.17672)
...
### [29] [AERR-Nav: Adaptive Exploration-Recovery-Reminiscing Strategy for Zero-Shot Object Navigation](https://arxiv.org/abs/2603.17712)
...
### [30] [VolumeDP: Modeling Volumetric Representation for Manipulation Policy Learning](https://arxiv.org/abs/2603.17720)
...
### [31] [Multi-Source Human-in-the-Loop Digital Twin Testbed for Connected and Autonomous Vehicles in Mixed Traffic Flow](https://arxiv.org/abs/2603.17751)
...
### [32] [Huddle: Parallel Shape Assembly using Decentralized, Minimalistic Robots](https://arxiv.org/abs/2603.17768)
...
### [33] [EVA: Aligning Video World Models with Executable Robot Actions via Inverse Dynamics Rewards](https://arxiv.org/abs/2603.17808)
...
### [34] [Generative Control as Optimization: Time Unconditional Flow Matching for Adaptive and Robust Robotic Control](https://arxiv.org/abs/2603.17834)
...
### [35] [ProbeFlow: Training-Free Adaptive Flow Matching for Vision-Language-Action Models](https://arxiv.org/abs/2603.17850)
...
### [36] [DexViTac: Collecting Human Visuo-Tactile-Kinematic Demonstrations for Contact-Rich Dexterous Manipulation](https://arxiv.org/abs/2603.17851)
...
### [37] [RoboForge: Physically Optimized Text-guided Whole-Body Locomotion for Humanoids](https://arxiv.org/abs/2603.17927)
...
### [38] [Specification-Aware Distribution Shaping for Robotics Foundation Models](https://arxiv.org/abs/2603.17969)
...
### [39] [A Single-Fiber Optical Frequency Domain Reflectometry (OFDR)-Based Shape Sensing of Concentric Tube Steerable Drilling Robots](https://arxiv.org/abs/2603.17990)
